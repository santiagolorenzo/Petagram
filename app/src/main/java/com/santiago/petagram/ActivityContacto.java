...
public class ActivityContacto extends AppCompatActivity {
        ...
        btnEnviarEmail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    transport.connect("slorenzo.com.uy", Login.USER, Login.PASSWORD);
    ...
    public class Login {
        public static final String EMAIL = "petagram@slorenzo.com";
        public static final String USER = "petagram@slorenzo.com";
